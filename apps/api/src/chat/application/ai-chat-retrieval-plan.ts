...
const newSearchRefinementPattern =
  /\b(?:i mean|actually|instead|rather|maybe|no,?|not important|does not matter|doesn't matter|rent|rental|lease|buy|purchase|budget|under|studio|1 bedroom|one bedroom|2 bedroom|two bedroom|3 bedroom|three bedroom|move in|move-in|next month|spacious|jomtien|wongamat|naklua|pratumnak|pratamnak)\b|может|а если|точнее|вообще|лучше|аренд|купить|бюджет|студ|спальн|однушк|однокомнат|двушк|двухкомнат|трешк|трёшк|трехкомнат|трёхкомнат|джомтьен|вонгамат|наклуа|пратамнак|въезд|заезд|месяц|จอมเทียน|วงศ์อมาตย์|นาเกลือ|พระตำหนัก/i;
