...
import styles from "./agency-analytics-panel.module.css";

export function AgencyAnalyticsPanel({ metrics }: { metrics: TenantDashboardMetrics }) {
  return (
    <>
      <section className={styles.kpiGrid} aria-label="Agency analytics overview">
        ...
        <KpiCard
          icon={<Bot size={18} />}
          label="Concierge conversion"
          note={`${metrics.conciergeLeads} leads`}
