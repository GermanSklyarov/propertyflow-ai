...
export function getTenantWidgetSettings(tenant: TenantSnapshot): TenantSnapshot["widget"] {
  ...
  return {
    ...
    leadLineChannelSecret: tenant.widget?.leadLineChannelSecret ?? defaultTenantWidgetSettings.leadLineChannelSecret,
    ...
    leadTelegramBotUsername: tenant.widget?.leadTelegramBotUsername ?? defaultTenantWidgetSettings.leadTelegramBotUsername,
