...
export interface CreatePropertyImportUploadRequest {
  filename: string;
  mimeType: string;
  sizeBytes?: number;
}

export interface CreatePropertyImportUploadResponse {
  bucket: string;
  objectKey: string;
  objectUrl: string;
  uploadUrl: string;
...
export interface SavedPropertySearchAlertItem {
  savedSearch: SavedPropertySearchSnapshot;
  currentMatchCount: number;
  recommendations: SavedPropertySearchRecommendation[];
}

export interface SavedPropertySearchAlertsResponse {
  items: SavedPropertySearchAlertItem[];
  total: number;
  generatedAt: string;
}

export interface SavedSearchAlertRunItem {
  savedSearchId: string;
  title: string;
  currentMatchCount: number;
}

export interface SavedSearchAlertRunSnapshot {
  id: string;
  tenantId: string;
...
export interface SavedSearchLeadFunnelItem {
  savedSearch: SavedPropertySearchSnapshot;
  leadCount: number;
...
export interface ApplyLeadQualityLinkPropertyRequest {
  propertyId: string;
  note?: string;
}

export interface ApplyLeadQualityLinkPropertyResponse {
  lead: LeadSnapshot;
  note?: LeadNoteSnapshot;
}
...
export interface LeadSlaSourcePerformanceItem {
  source: LeadSource;
  total: number;
  open: number;
  won: number;
...
export interface LeadSlaSourcePerformanceResponse {
  items: LeadSlaSourcePerformanceItem[];
  total: number;
  targetFirstResponseHours: number;
  filters: ListLeadsRequest;
  generatedAt: string;
...
export interface LeadConversionSourcePerformanceItem {
  source: LeadSource;
  total: number;
  open: number;
  won: number;
...
export interface LeadConversionSourcePerformanceResponse {
  items: LeadConversionSourcePerformanceItem[];
  total: number;
  filters: ListLeadsRequest;
  generatedAt: string;
}
...
export interface LeadQualitySourcePerformanceItem {
  source: LeadSource;
  total: number;
  affectedLeads: number;
  issueCount: number;
...
export interface LeadQualitySourcePerformanceResponse {
  items: LeadQualitySourcePerformanceItem[];
  total: number;
  filters: ListLeadsRequest;
  generatedAt: string;
}
